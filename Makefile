ifeq ($(TARGET),rhel)
  ...
  REPOSITORY := openshiftio/rhel-fabric8-maven-analytics-release-monitor
else
  DOCKERFILE := Dockerfile
  REPOSITORY := openshiftio/fabric8-maven-analytics-release-monitor
endif

REGISTRY?=quay.io
DEFAULT_TAG=latest
TESTS_IMAGE=fabric8-analytics-maven-release-monitor-tests
